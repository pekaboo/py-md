...
::: ### 打开详情
 ...
 #### 📌 加分项：
 举例说明（加载自定义 java.lang.String 会被 Bootstrap 拒绝）；补充 <clinit>() 特点（自动生成、按顺序执行）；提到自定义类加载器应用场景（加密 Class 文件、热部署、模块隔离）。
 #### ⚠️注意事项：
...
::: hide   📚 13. 【场景】线上频繁Full GC， OOM问题排查 
### 回答要点关键字  
...
### 40. 【面试题目】JVM 频繁 Full GC 的排查思路，请列出至少三种可能导致频繁 Full GC 的原因及排查方法？
#### 回答要点关键字
